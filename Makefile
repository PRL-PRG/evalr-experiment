...
RUN_DIR            ?= $(PROJECT_BASE_DIR)/evalr-experiment/run
...
PACKAGE_SUM_REFLECTION_FILE	:= $(PACKAGE_PREPROCESS_DIR)/summarized-reflection.fst
...
BASE_SUM_REFLECTION_FILE := $(BASE_PREPROCESS_DIR)/summarized-reflection.fst
...
KAGGLE_SUM_REFLECTION_FILE := $(KAGGLE_PREPROCESS_DIR)/summarized-reflection.fst
...
$(BASE_PREPROCESS_FILES): $(PACKAGES_CORE_FILE) $(BASE_TRACE_EVAL_CALLS)
    ...
    --out-undefined $(BASE_SUM_UNDEFINED_FILE) \
	  --out-summarized-reflection $(BASE_SUM_REFLECTION_FILE)
...
$(KAGGLE_PREPROCESS_FILES): $(PACKAGES_CORE_FILE) $(KAGGLE_TRACE_EVAL_CALLS)
    ...
    --out-undefined $(KAGGLE_SUM_UNDEFINED_FILE) \
	  --out-summarized-reflection $(KAGGLE_SUM_REFLECTION_FILE)
